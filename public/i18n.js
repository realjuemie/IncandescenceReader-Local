...
(() => {
  ...
  const messages = {
    "zh-CN": {
      ...
      noReadableAccountsHelp: "管理员添加账号并完成抓取后，会自动显示在这里。", noBio: "暂无个人简介",
      ...
      publicDisplay: "公开展示", replies: "回复", reposts: "转发", saveSettings: "保存设置", syncing: "更新中…", syncNow: "立即更新", preview: "预览",
    ...
    en: {
      ...
      noReadableAccountsHelp: "Accounts will appear here after an administrator adds and syncs them.", noBio: "No bio available",
      ...
      publicDisplay: "Public", replies: "Replies", reposts: "Reposts", saveSettings: "Save settings", syncing: "Syncing…", syncNow: "Sync now", preview: "Preview",
