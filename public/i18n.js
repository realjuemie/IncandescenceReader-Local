...
(() => {
  ...
  const staticText = {
    ...
    "搜索名称、@用户名或账号 ID": "Search name, @handle, or account ID",
  ...
  const messages = {
    "zh-CN": {
      ...
      shareLink: "分享链接", createAndCopy: "创建并复制", creatingShare: "正在创建安全链接…", shareCopiedUntil: "链接已复制，有效至 {time}", shareCopied: "临时分享链接已复制", copyFailed: "浏览器未允许自动复制，请手动复制上方链接", close: "关闭",
    ...
    en: {
      ...
      shareLink: "Share link", createAndCopy: "Create and copy", creatingShare: "Creating secure link…", shareCopiedUntil: "Link copied; valid until {time}", shareCopied: "Temporary link copied", copyFailed: "The browser blocked automatic copying; copy the link above manually", close: "Close",
