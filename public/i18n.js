...
(() => {
  ...
  const staticText = {
    ...
    "搜索名称、@账号或 ID": "Search name, @user or ID",
    ...
    "↻ 一键重试失败账号": "↻ Retry failed accounts",
    ...
    "Telegram Mini App 与机器人": "Telegram Mini App and bot",
    "绑定会员、自动登录并同步发送更新通知。保存配置后可一键设置 Webhook、机器人命令和 Mini App 菜单。": "Bind members, sign in automatically, and mirror update alerts. Save once to configure the webhook, bot commands, and Mini App menu.",
    "管理员 Telegram ID": "Administrator Telegram ID",
    "发送 /whoami 可查看": "Send /whoami to find it",
    "App api_id（可选）": "App api_id (optional)",
    "App api_hash（可选）": "App api_hash (optional)",
    "Bot API 代理（可选）": "Bot API proxy (optional)",
    "例如 http://127.0.0.1:7897": "For example, http://127.0.0.1:7897",
    "Telegram Bot API 使用独立代理": "Use a dedicated proxy for the Telegram Bot API",
    "留空保留已保存的 Token": "Leave blank to keep the saved token",
    "将增量更新和 X 凭证失效同步通知管理员": "Notify the administrator about new content and expired X credentials",
    "Mini App 使用上方“站点访问地址”，必须是 Telegram 能访问的 HTTPS 域名。api_id 与 api_hash 仅预留给后续 MTProto 功能，当前 Bot API 不需要它们。": "The Mini App uses the public site URL above, which must be an HTTPS domain reachable by Telegram. api_id and api_hash are reserved for future MTProto features and are not required by the Bot API.",
    "尚未部署到 Telegram": "Not deployed to Telegram",
    "先保存配置，再验证机器人": "Save the configuration before testing the bot",
    "验证 Bot": "Verify bot",
    "测试通知": "Test notification",
    "保存配置": "Save configuration",
    "保存并部署到 Telegram": "Save and deploy to Telegram",
  ...
  const messages = {
    "zh-CN": {
      ...
      memberOnly: "会员专属", adminOnly: "仅管理可见", temporaryAccess: "临时访问", temporaryAccessShort: "临时",
      publicSummary: "{publicCount} 个公开账号{privatePart} · {latestPart}", publicAccountCount: "{count} 个公开账号", temporaryAccountCount: "{count} 个临时访问账号",
      privateAccountCount: "{count} 个{label}", accountDirectorySummary: "{access} · {latestPart}",
      accountCount: "{count} 个账号", filteredAccountCount: "显示 {shown} / {total}", noAccountMatches: "没有找到匹配账号", tryAnotherAccountSearch: "试试名称、@用户名或账号 ID 的一部分",
      ...
      noReadableAccountsHelp: "管理员添加账号并完成抓取后，会自动显示在这里。",
      showPublicAccounts: "显示公开", hidePublicAccounts: "隐藏公开",
      noExclusiveAccounts: "还没有专属账号",
      noExclusiveAccountsHelp: "管理员分配后会显示在这里。也可点右上角查看公开账号。", readerAccountNotFound: "账号不存在或无权访问",
      ...
      technicalInfo: "技术信息：{detail}", retrySync: "重新更新", retryingFailed: "正在重试 {count} 个账号…",
      retryFailedDone: "重试完成：{ok} 个失败账号已恢复", retryFailedResult: "重试完成：成功 {ok}，仍失败 {failed}（{accounts}）",
      accountMemberTotal: "共 {accounts} 个 · {members} 个会员",
      ...
      temporaryShareTitle: "创建临时分享链接", temporaryShareIntro: "链接仅允许浏览 @{username} 的本站内容，到期后自动失效。", validFor: "有效时长", timeUnit: "单位", hours: "小时", days: "天", minutes: "分钟",
      popularDurations: "常用时长", durationHours: "{count} 小时", durationDays: "{count} 天", customDuration: "自定义时长", decreaseDuration: "减少时长", increaseDuration: "增加时长",
      shareLink: "分享链接", webShareLink: "网页临时链接", telegramShareLink: "Mini App 临时链接", copyAction: "复制", linkCopied: "链接已复制", createAndCopy: "创建并复制", creatingShare: "正在创建安全链接…", shareCopiedUntil: "网页链接已复制；两个入口均有效至 {time}", shareCopied: "临时分享链接已创建", copyFailed: "浏览器未允许自动复制，请手动复制上方链接", close: "关闭",
      memberCreated: "会员 {username} 已创建，请为其分配可查看用户", noMembers: "尚未创建会员。会员登录后只能看到公开用户和分配给自己的非公开用户。",
      lastLogin: "上次登录 {time}", createdAt: "创建于 {time}", unsavedChanges: "有未保存更改", allowLogin: "允许登录", visibleAccounts: "可查看的用户", selectedAccountCount: "已选择 {count} 个",
    ...
    en: {
      ...
      memberOnly: "Members only", adminOnly: "Admin only", temporaryAccess: "Temporary access", temporaryAccessShort: "Temporary",
      publicSummary: "{publicCount} public accounts{privatePart} · {latestPart}", publicAccountCount: "{count} public", temporaryAccountCount: "{count} temporary",
      privateAccountCount: "{count} {label}", accountDirectorySummary: "{access} · {latestPart}",
      accountCount: "{count} accounts", filteredAccountCount: "Showing {shown} of {total}", noAccountMatches: "No matching accounts", tryAnotherAccountSearch: "Try part of a name, @handle, or account ID",
      ...
      noReadableAccountsHelp: "Accounts will appear here after an administrator adds and syncs them.",
      showPublicAccounts: "Show public", hidePublicAccounts: "Hide public",
      noExclusiveAccounts: "No exclusive accounts yet",
      noExclusiveAccountsHelp: "Assigned accounts appear here. You can also show public accounts from the toolbar.", readerAccountNotFound: "Account unavailable",
      ...
      technicalInfo: "Technical details: {detail}", retrySync: "Retry sync", retryingFailed: "Retrying {count} accounts…",
      retryFailedDone: "Retry complete: {ok} failed accounts recovered", retryFailedResult: "Retry complete: {ok} succeeded, {failed} still failed ({accounts})",
      accountMemberTotal: "{accounts} accounts · {members} members",
      ...
      temporaryShareTitle: "Create temporary access link", temporaryShareIntro: "This link grants read-only access to @{username} until it expires.", validFor: "Valid for", timeUnit: "Unit", hours: "Hours", days: "Days", minutes: "Minutes",
      popularDurations: "Popular durations", durationHours: "{count}h", durationDays: "{count}d", customDuration: "Custom duration", decreaseDuration: "Decrease duration", increaseDuration: "Increase duration",
      shareLink: "Share link", webShareLink: "Web temporary link", telegramShareLink: "Mini App temporary link", copyAction: "Copy", linkCopied: "Link copied", createAndCopy: "Create and copy", creatingShare: "Creating secure link…", shareCopiedUntil: "Web link copied; both entry points remain valid until {time}", shareCopied: "Temporary links created", copyFailed: "The browser blocked automatic copying; copy the link above manually", close: "Close",
      ...
      lastLogin: "Last sign-in {time}", createdAt: "Created {time}", unsavedChanges: "Unsaved changes", allowLogin: "Allow sign-in", visibleAccounts: "Visible accounts", selectedAccountCount: "{count} selected",
